...
| Find a specific document | [Complete generated inventory](inventory.md) |
| Find historical research sessions | [Research-log index](../reports/research-log-index.md) |
...
Existing section anchors are retained below for incoming links.

<a id="core-state"></a>
[Core state](catalogue.md#core-state)

<a id="claims-and-obstructions"></a>
[Claims and obstructions](catalogue.md#claims-and-obstructions)

<a id="computation-and-certification"></a>
[Computation and certification](catalogue.md#computation-and-certification)

<a id="planning-and-provenance"></a>
[Planning and provenance](catalogue.md#planning-and-provenance)
