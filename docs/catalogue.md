# Annotated documentation catalogue

Retained annotations from the documentation map at `3899662`. This catalogue is
reference navigation; [the topic map](index.md) is the starting point and
[the generated inventory](inventory.md) is the complete file list.
...
- [`../metadata/n9_review_decision_intake.yaml`](../metadata/n9_review_decision_intake.yaml):
  machine-readable reviewer-decision intake contract for accepted gates,
  rejected gates, exact gaps, and allowed follow-up outcomes.
...
- [`relation-skeleton-catalog.md`](relation-skeleton-catalog.md):
  ...
  includes local-lemma and closed-descent accounting crosswalks and remains a
...
- [`bootstrap-t12-81-3-second-supply-chains.md`](bootstrap-t12-81-3-second-supply-chains.md):
  second-step prefix crosswalk leaving one center-`8` then center-`2` prefix
  and no immediate center-`6` label-`6` supply extension for it.
...
- [`bootstrap-t12-151-6-private-lane-strict-core-split.md`](bootstrap-t12-151-6-private-lane-strict-core-split.md):
  checked proof-target split of all row-`6` three-row strict-cycle cores into
  label-`8`-visible and label-`8`-free cases.
...
- [`n9-vertex-circle-witness-pair-cap-audit.md`](n9-vertex-circle-witness-pair-cap-audit.md):
  row-level audit of the witness-pair cap and partial count pruning in the
  exhaustive `n=9` vertex-circle checker.
...
- [`n9-vertex-circle-t06-self-edge-lemma.md`](n9-vertex-circle-t06-self-edge-lemma.md):
  focused review-pending T06/F11 self-edge local lemma packet for proof
  mining.
- [`n9-vertex-circle-t06-soundness-review-2026-06-09.md`](n9-vertex-circle-t06-soundness-review-2026-06-09.md):
  internal soundness review accepting only the T06/F11 local self-edge
...
- [`n9-t06-self-edge-minireplay.md`](n9-t06-self-edge-minireplay.md):
  minimal input-data replay of the T06/F11 local self-edge family packet;
  proof-mining scaffolding only.
