...
It supersedes the informal slack recommendation in the archived exploration
note at `C:\Users\User\Desktop\code\erd archive\outputs\data\1\erdos97_32_explorations_v2.md`,
but only as planning guidance.
