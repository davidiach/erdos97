...
theorem witnessInSet_center_ne_a {Point : Type u} {A : Point -> Prop}
    {p : Point} {W : Witness4 Point} (h : WitnessInSet A p W) :
    Not (p = W.a) := by
  intro hp
...
theorem witnessInSet_center_ne_b {Point : Type u} {A : Point -> Prop}
    {p : Point} {W : Witness4 Point} (h : WitnessInSet A p W) :
    Not (p = W.b) := by
  intro hp
...
theorem witnessInSet_center_ne_c {Point : Type u} {A : Point -> Prop}
    {p : Point} {W : Witness4 Point} (h : WitnessInSet A p W) :
    Not (p = W.c) := by
  intro hp
...
theorem witnessInSet_center_ne_d {Point : Type u} {A : Point -> Prop}
    {p : Point} {W : Witness4 Point} (h : WitnessInSet A p W) :
    Not (p = W.d) := by
  intro hp
...
theorem hasFourEquidistantProperty_exists_witnessInSet {Point : Type u}
    {A : Point -> Prop}
...
theorem hasFourEquidistantProperty_exists_witnessEquidistant {Point : Type u}
    {A : Point -> Prop}
    {SameDistanceFrom : Point -> Point -> Point -> Prop}
    (h : HasFourEquidistantProperty A SameDistanceFrom) (p : Point)
    (hp : A p) :
