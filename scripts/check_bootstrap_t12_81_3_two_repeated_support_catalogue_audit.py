#!/usr/bin/env python3
"""Check the bootstrap/T12 81:3 two-repeated-support catalogue audit."""
...
from erdos97.bootstrap_t12_81_3_two_repeated_support_catalogue_audit import (  # noqa: E402
    DEFAULT_ARTIFACT,
...
def print_summary(payload: dict[str, object]) -> None:
    ...
    print("bootstrap / T12 81:3 two-repeated-support catalogue audit")
    print(
        "two-repeated support catalogues: "
        f"{summary['two_repeated_support_catalogue_count']}"
    )
    print(
        "ordered generation paths: "
        f"{summary['ordered_two_repeated_generation_path_count']}"
    )
...
def main() -> int:
    ...
    generated = build_t12_81_3_two_repeated_support_catalogue_audit_payload()
    payload = generated
    ...
    if args.json:
        ...
        if args.check:
            print("OK: stored bootstrap/T12 81:3 two-repeated-support artifact matches")
        if args.assert_expected:
