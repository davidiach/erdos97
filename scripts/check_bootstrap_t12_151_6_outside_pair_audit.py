#!/usr/bin/env python3
"""Check the bootstrap/T12 151:6 outside-pair audit."""
...
from erdos97.bootstrap_t12_151_6_outside_pair_audit import (  # noqa: E402
    DEFAULT_ARTIFACT,
...
def print_summary(payload: dict[str, object]) -> None:
    ...
    print("bootstrap / T12 151:6 outside-pair audit")
    print(f"row-6 candidate count: {summary['target_center_candidate_count']}")
    print(
...
def main() -> int:
    ...
    generated = build_t12_151_6_outside_pair_audit_payload()
    payload = generated
    ...
    if args.json:
        ...
        if args.check:
            print("OK: stored bootstrap/T12 151:6 outside-pair artifact matches")
        if args.assert_expected:
            print("OK: bootstrap/T12 151:6 outside-pair expectations verified")
    return 0
