#!/usr/bin/env python3
"""Generate the full n=9 D=3 incidence-capacity packet ledger."""
...
from erdos97.n9_base_apex_d3_incidence_capacity_packet import (  # noqa: E402
    assert_expected_packet_counts,
    d3_incidence_capacity_packet_report,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("OK: n=9 D=3 incidence-capacity packet artifact is current")
    elif args.out is not None:
        print(f"wrote {display_path(out, ROOT)}")
    else:
        print("n=9 base-apex D=3 incidence-capacity packet ledger")
        print(
            "rows: "
