#!/usr/bin/env python3
"""Generate or check the minimal T08/F02 self-edge mini-replay artifact."""
...
from erdos97.n9_t08_self_edge_minireplay import (  # noqa: E402
...
DEFAULT_ARTIFACT = (
    ROOT / "data" / "certificates" / "n9_t08_self_edge_minireplay.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("n=9 T08/F02 self-edge mini-replay")
        ...
        if args.assert_expected:
            print("OK: T08/F02 mini-replay matches expected data")
        if args.check:
