#!/usr/bin/env python3
"""Generate or check the minimal T03 self-edge mini-replay artifact."""
...
from erdos97.n9_t03_self_edge_minireplay import (  # noqa: E402
...
DEFAULT_ARTIFACT = (
    ROOT / "data" / "certificates" / "n9_t03_self_edge_minireplay.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("n=9 T03 self-edge mini-replay")
        ...
        if args.assert_expected:
            print("OK: T03 mini-replay matches expected data")
        if args.check:
