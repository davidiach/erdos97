...
def assert_expected_416_447(data: Mapping[str, object]) -> None:
    ...
    if sum(int(count) for count in fallback_supports.values()) != int(
        ...
        raise AssertionError("window 416-447 fallback histogram total changed")
...
def assert_expected_448_479(data: Mapping[str, object]) -> None:
    ...
    if sum(int(count) for count in fallback_supports.values()) != int(
        ...
        raise AssertionError("window 448-479 fallback histogram total changed")
