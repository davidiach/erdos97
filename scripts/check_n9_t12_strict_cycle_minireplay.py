#!/usr/bin/env python3
"""Generate or check the minimal T12/F16 strict-cycle mini-replay artifact."""
...
from erdos97.n9_t12_strict_cycle_minireplay import (  # noqa: E402
...
DEFAULT_ARTIFACT = (
    ROOT / "data" / "certificates" / "n9_t12_strict_cycle_minireplay.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("n=9 T12/F16 strict-cycle mini-replay")
        ...
        if args.assert_expected:
            print("OK: T12/F16 mini-replay matches expected data")
        if args.check:
