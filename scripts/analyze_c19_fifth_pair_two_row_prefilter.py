...
def assert_expected(data: Mapping[str, Any]) -> None:
    ...
    expected_aggregate = {
        ...
        "fallback_certificate_digest": "1c09e3b2b7b147172f3d703bb2968a5ed66a84f550b65fc27cd55d9dc173e7ee",
    ...
    if histograms["fallback_support_size"] != {"50": 1, "56": 1, "59": 1}:
        raise AssertionError("fallback support-size histogram changed")
