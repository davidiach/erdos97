    ...
    for iteration in range(max_rounds):
        ...
        if state=='exact obstruction':
            ...
            for certificate in record['strong_preflight']['certificates']:
                ...
                if cut in prior_cuts:raise RuntimeError('solver repeated an earlier excluded row assignment')
                if cut in cuts:continue  # multiple valid certificates can yield the same new cut
